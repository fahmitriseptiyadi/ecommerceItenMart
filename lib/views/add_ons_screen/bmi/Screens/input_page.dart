import 'package:ItenMart/views/add_ons_screen/bmi/Screens/calculator_brain.dart';
import 'package:ItenMart/views/add_ons_screen/bmi/Screens/constants.dart';
...
class _InputPageState extends State<bmiCalcScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Body Max Index Calculator"),
      ),
      body: Column(
